...
> devtools::install_github(“AbrahamAz/translateREACH”)
...
```{r}
other_columns <- c("reason_bad_relationship_other")
  tool.survey %>% filter(type == "text") %>% pull(name)

responses <- find.responses(data.list$main,other_columns,values_to = "response.uk")
responses.j <- translate.responses(responses, language_codes = "sk")
```
