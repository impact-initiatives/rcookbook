...
```{r}
counts <- lapply(numerical_questions[,1:52], sum, na.rm = TRUE) #Calculating count of observation for each variable
numerical_questions <- numerical_questions[ , !(names(numerical_questions) %in% names(subset(counts, counts < 3)))]
