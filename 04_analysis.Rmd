...
Now we can use a dap, which mainly consists of a dataframe with needed informations for performing the analysis. One line is one requested analysis. Usually an excel sheet is the easiest way to go as it can be co-constructed by both an AO and a DO.
